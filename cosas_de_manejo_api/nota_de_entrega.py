...
def crear_nota_entrega(cliente, almacen, comentario):
    """Crea una nota de entrega en Frappe a partir de un CSV remoto predefinido"""

    # 🔗 URL FIJA del Google Sheets público
    ...
    os.system("clear")
    comentario_html = texto_a_html(comentario)
    items = leer_items_csv_desde_url()
    ...
    if response.status_code == 200:
        ...
        os.system(f"xdg-open http://localhost/desk#Form/Delivery%20Note/{docname}")
        return docname
    else:
